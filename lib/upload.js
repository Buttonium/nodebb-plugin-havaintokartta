...
/**
 * Magic-number (file signature) validation for each allowed image type.
 * Returns true if the buffer's leading bytes match the claimed MIME type.
 *
 * References:
 ...
 *   - WebP: https://en.wikipedia.org/wiki/WebP#RIFF_container
 *   - HEIC/HEIF: https://github.com/nickkraakman/heif-spec
 */
const MAGIC_NUMBERS = {
  'image/jpeg': [
    [0xFF, 0xD8, 0xFF],
...
// All image types share identical logic; only the directory and URL
// prefix differ. These two functions eliminate ~300 lines of copy-paste.
