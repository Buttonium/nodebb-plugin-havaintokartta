...
function deserializeService(value) {
  ...
  return {
    ...
    baseZoom: value.baseZoom ? Number(value.baseZoom) : undefined,
...
async function createService(payload, actorUid) {
  ...
  const service = {
    ...
    baseZoom: typeof payload?.baseZoom === 'number' ? payload.baseZoom : undefined,
...
async function updateService(serviceId, payload, actorUid) {
  ...
  if (payload?.baseZoom !== undefined) {
    updated.baseZoom = typeof payload.baseZoom === 'number' ? payload.baseZoom : undefined;
  }
